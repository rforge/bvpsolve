...
# lsoda!
out <- ode(func=E3, jacfunc = jac, parms=parms, y = yini, times=times,
  atol=1e-15, rtol=1e-15, maxsteps=1e5, method="lsode")

out <- mebdfi(func=E3, jacfunc = jac, parms=parms, y = yini, times=times,
  atol=1e-16, rtol=1e-16, maxsteps=1e6)

plot(out, type="l", lwd=2, col="darkblue", log="xy", ylim =c(1e-30,1e-3))
...
exact <-c(0.1152903278711829e-290,y2=0.8867655517642120e-22,
