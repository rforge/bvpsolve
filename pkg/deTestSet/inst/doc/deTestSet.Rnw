...
plot(out, which=1:9, type="l", lwd=2, ask=FALSE)
...
plot(out, type="l", lwd=2, ask=FALSE, log="xy")
...
plot(out,   type="l", lwd=2, ask=FALSE)
...
plot(out, type="l", lwd=2, ask=FALSE, log="y")
...
plot(out,   type="l", lwd=2, ask=FALSE, log="x")
...
plot(out, which=1:6, type="l", lwd=2, ask=FALSE)
...
2008. Available at http://www.dm.uniba.it/\~testset.
 ...
 Karline Soetaert, Thomas Petzoldt and R. Woodrow Setzer (2009). deSolve: General
  ...
  and delay differential equations (DDE). R package version 1.7.
