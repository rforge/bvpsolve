...
\title{Solving Differential Equations in R (book) - DAE examples}

\Plaintitle{Solving Differential Equations in R (book) - DAE examples}

\Keywords{differential algebraic equations, initial value problems, examples, R}

\Plainkeywords{differential algebraic equations, initial value problems, examples, R}
...
\Abstract{This vignette contains the R-examples of chapter 6 from the book:
...
%\VignetteIndexEntry{DAE examples from the book Solving Differential Equations in R by Soetaert, Cash and Mazzia (2012)}
%\VignetteKeywords{differential algebraic equations, examples}
%\VignettePackage{Solving DAEs in R}
...
\section{A simple DAE of Index 2}
<<>>=
...
\clearpage
\section{A Nonlinear Implicit DAE of index 1}
<<>>=
...
\begin{figure}
\begin{center}
<<label=pendulum,fig=TRUE,echo=FALSE, png=TRUE, pdf=FALSE, eps=FALSE>>=
<<pendulum>>
@
\end{center}
\caption{Solution of the pendulum problem. See book for explanation.}
\label{fig:pendulum}
\end{figure}
@
\clearpage
...
\begin{figure}
\begin{center}
<<label=caraxis,fig=TRUE,echo=FALSE, png=TRUE, pdf=FALSE, eps=FALSE>>=
<<caraxis>>
@
\end{center}
\caption{The car axis problem. See book for explanation.}
\label{fig:caraxis}
\end{figure}
\clearpage
\section{The Transistor Amplifier}
<<>>=
library(deSolve)
...
\begin{figure}
\begin{center}
<<label=transistor,fig=TRUE,echo=FALSE, width=6, height=3, png=TRUE, pdf=FALSE, eps=FALSE>>=
<<transistor>>
@
\end{center}
\caption{The transistor amplifier. See book for more information.}
\label{fig:trans}
\end{figure}
