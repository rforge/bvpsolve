...
\title{Solving Differential Equations in R (book) - DDE examples}

\Plaintitle{Solving Differential Equations in R (book) - DDE examples}

\Keywords{delay differential equations, initial value problems, examples, R}

\Plainkeywords{delay differential equations, initial value problems, examples, R}
...
\Abstract{This vignette contains the R-examples of chapter 8 from the book:
...
%\VignetteIndexEntry{DDE examples from the book Solving Differential Equations in R by Soetaert, Cash and Mazzia (2012)}
%\VignetteKeywords{delay differential equations, examples}
%\VignettePackage{Solving DDEs in R}
...
\clearpage
\section{Chaotic Production of White Blood Cells}
<<>>=
...
\begin{figure}
\begin{center}
<<label=mackey,fig=TRUE,echo=FALSE, png=TRUE, pdf=FALSE, eps=FALSE>>=
<<mackey>>
@
\end{center}
\caption{The Mackey-Glass DDE. See book for more information.}
\label{fig:mackey}
\end{figure}

\clearpage
\section{A DDE involving a Root Function}
<<>>=
...
\begin{figure}
\begin{center}
<<label=mariot,fig=TRUE,echo=FALSE, png=TRUE, pdf=FALSE, eps=FALSE>>=
<<mariot>>
@
\end{center}
\caption{Solution of the Controller problem. See book for explanation.}
\label{fig:mariot}
\end{figure}

\clearpage
\section{Vanishing Time Delay}
<<>>=
...
@
\clearpage
\section{Predator-Prey Dynamics with Harvesting}
<<>>=
...
@
<<label=ddeevent,include=FALSE>>=
plot(yout[,-1], type = "l")
@
\setkeys{Gin}{width=0.6\textwidth}
\begin{figure}
\begin{center}
<<label=ddeevent,fig=TRUE,echo=FALSE, png=TRUE, pdf=FALSE, eps=FALSE>>=
<<ddeevent>>
@
\end{center}
\caption{Solution of the predator-prey DDE model. See book for explanation.}
\label{fig:predprey}
\end{figure}
