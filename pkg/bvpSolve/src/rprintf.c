...
void F77_SUB(rprintfd3)(const char* msg, double *d1, double *d2, double *d3 FCLEN) {
  Rprintf(msg, *d1, *d2, *d3);
  Rprintf("\n");
}

void F77_SUB(rprintfd4)(const char* msg, double *d1, double *d2, double *d3, double *d4 FCLEN) {
  Rprintf(msg, *d1, *d2, *d3, *d4);
  Rprintf("\n");
}
...
void F77_SUB(rprintfi4)(const char* msg, int *i1, int *i2, int* i3, int *i4 FCLEN) {
  Rprintf(msg, *i1, *i2, *i3, *i4);
  Rprintf("\n");
}
