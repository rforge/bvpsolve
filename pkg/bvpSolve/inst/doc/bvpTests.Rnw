...
<<>>=
xi <- 0.0005
twp3  <- bvptwp(yini=c(-1,NA),yend=c(1,NA),x=x,func=prob7,xguess=twp2[,1],
  yguess = t(twp2[,-1]))
...
mod3  <- bvptwp(yini=ini,yend=end,x=seq(0,1,by=0.01),
        func=Prob24, xi=xi, xguess = mod2[,1], yguess = t(mod2[,2:3]))
@
<<>>=
xi <- 0.005
mod4  <- bvptwp(yini=ini,yend=end,x=seq(0,1,by=0.01),
        func=Prob24, xi=xi, xguess = mod3[,1], yguess = t(mod3[,2:3]))
@
